...
import { ApplicationWorkflowService, AuthentificationStore } from 'app/service/services.module';
...
export class UpdateAscodeComponent {
    ...
    constructor(private _modalService: SuiModalService, private _awService: ApplicationWorkflowService,
                ...
                private _workflowService: WorkflowService, private _authStore: AuthentificationStore) {
    }
